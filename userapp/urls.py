...
from .views import HomeView, SurvivorSignUp, Dashboard, RecordAnAssault, RecordAssault2, AssaultRecordQuestionAnswer, \
    ...
    UpdateAssaultForm, DeleteProviderSlot, EditProviderSlot, ServiceProviderSignupFirstStep
...
urlpatterns = [
                  ...
                  path('survivor-login-by-mobile/', SurvivorLoginByMobileNumberView.as_view(),
                       name='survivor-login-by-mobile'),
                  ...
                  path("provider-password-reset-confirm/<uidb64>/<token>/", ProviderPasswordResetConfirmView.as_view(),
                       name="provider-password-reset-confirm"),
                  path("password-reset-done/",
                       PasswordResetDoneView.as_view(template_name='userapp/password_reset_done.html'),
                       name="password-reset-done"),
                  ...
                  path('service-provider-signup-first-step/', ServiceProviderSignupFirstStep.as_view(),
                       name='service-provider-signup-first-step'),
